...
def add_cafe():
    ...
    if form.validate_on_submit():
        with open("cafe-data.csv", "a") as file:
            csv.writer(file).writerow([form.cafe.data, form.location.data, form.open_time.data, form.close_time.data, form.coffee_rate.data, 
                                       form.wifi_rate.data, form.power_avail.data])
